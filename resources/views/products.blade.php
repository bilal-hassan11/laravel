...
@section('content')
@include('inc.filter')
<p class="btn-holder"><a href="{{ url('generate_txt') }}" class="btn btn-warning btn-block text-center" role="button">Generate TXT</a> </p>
...
<div class="col-xs-12 col-md-6">
                    ...
                    @foreach($products as $product)
                      ...
                      <div class="row">
                           <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <img src="public/{{ $product->photo }}" class="img-responsive" width="200px">
                       </div>
     ...
     <div class="col-md-7 col-sm-12 col-xs-12">
                  ...
                  <div class="product-deatil">
                               ...
                               <a href="#"><strong><h3>{{ $product->name }}</h3></strong></a>
                               <br />
                               <a href="#">PRODUCT COLOR:&nbsp;&nbsp;{{ $product->color }}</a>
                               <br />
                               <a href="#">Qty&nbsp;&nbsp;{{ $product->quantity }}</a>
                               <br /><br />                      
 
                        </h5>
                            <p class="price-container"><span><strong>Price: </strong> {{ $product->price }}$</span></p>
 
              <span class="tag1"></span>
 
   </div>
 
   <div class="description"><p>{{ Str::limit(strtolower($product->description), 50) }} </p></div>
      ...
      <div class="product-info smart-form">
         ...
         <div class="col-md-12">
          ...
          <a href="{{ url('add-to-cart/'.$product->id) }}" class="btn btn-danger">Add to cart</a>
      ...
      <div class="col-md-12">
        ...
        <form class="form-horizontal poststars" action="{{route('rating', $product->id)}}" id="addStar" method="POST">
            {{ csrf_field() }}
